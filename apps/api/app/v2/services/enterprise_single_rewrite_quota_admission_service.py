...
class EnterpriseQuotaAdmissionDeniedError(RuntimeError):
    def __init__(
        self,
        result: EnterpriseQuotaEnforcementResult,
    ) -> None:
        self.result = result
        super().__init__("enterprise quota admission denied")


class EnterpriseSingleRewriteQuotaAdmissionService:
    def __init__(
        self,
        *,
